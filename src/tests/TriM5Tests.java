...
public class TriM5Tests extends ApplicationTest {
    ...
    public void testWeaponDamage() {
        ...
        verifyThat("#monHealth", (Label monsterHealth) -> !monsterHealth.getText().contains("" + expectedWeaponDamage));
    }
    ...
    public void testSwappedWeapon() {
        ...
        verifyThat("#monHealth", (Label monsterHealth) -> !monsterHealth.getText().contains("" + expectedNewWeaponDamage));
    }
}
